...
/* harmony import */ var _modules_accodion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accodion */ "./src/js/modules/accodion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_accodion__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content').init();
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init();
});

/***/ }),

/***/ "./src/js/modules/accodion.js":
/*!************************************!*\
  !*** ./src/js/modules/accodion.js ***!
  \************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Accodion; });
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        ...
        btn.addEventListener('click', function () {
          ...
          sibling.classList.toggle('msg'); // btn.closest('.module__info-show').nextElementSibling.style.display = "block";
        });
      });
    }
  }]);
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMassage.textContent = _this.message.loading;
          var formData = new FormData(item);

          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusMassage.textContent = _this.message.success;
          }).catch(function (e) {
            statusMassage.textContent = _this.message.failure;
          }).finally(function () {
            _this.clearInputs();
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playButton = this.activeBtn.querySelector('svg').cloneNode(true);
